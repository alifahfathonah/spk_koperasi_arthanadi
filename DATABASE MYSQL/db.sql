...
insert  into `tb_alternatif`(`id`,`kode_alternatif`,`id_nasabah`,`aktif`) values 
(1,'A1',1,1),
(2,'A2',2,1),
(3,'A3',3,1),
(4,'A4',5,1),
...
(25,'PGJ000003','A3','22.54','0','20.95','0','15.66','0','59.15','Layak','2022-05-28 15:19:34'),
(26,'PGJ000004','A4','0','0','0','20.95','0','13.02','33.97','Tidak Layak','2022-05-28 15:19:34');
...
insert  into `tb_kriteria`(`id`,`kode_kriteria`,`nama_kriteria`,`bobot_kriteria`,`aktif`) values 
(1,'C1','Surat Pegawai',5,1),
(2,'C1','Surat Bangunan',4,1),
(3,'C1','BPKB Mobil',3,1),
(4,'C1','BPKB Motor',2,1),
(5,'C1','Tidak Ada',1,1),
(6,'C2','Bertanggung Jawab',2,1),
(7,'C2','Kurang Dipercaya',1,1),
(8,'C6','Tidak',2,1),
(9,'C6','Ada',1,1);
...
insert  into `tb_nasabah`(`id`,`id_nasabah`,`nama_nasabah`,`alamat_nasabah`,`telepon`,`no_ktp`,`jenis_kelamin`,`agama`,`aktif`) values 
(1,'NB00001','I Wayan Jana Antara','Denpasar Timur','081999897666','01239131231222','L','Hindu',1),
(2,'NB00002','I Wayan Jana','Denpasar Timur','081999897565','01239131231223','L','Hindu',1),
(3,'NB00003','Ni Ketut Surati','Denpasar, Timur','081999876222','01239131231444','P','Hindu',1),
(4,'NB00004','I Wayan Subrata','Gianyar','081999897123','01239131231223','L','Hindu',1),
(5,'NB00005','Ahmad Saifulah','Jombang, Jawa Timur','081999891212','01239131231211','L','Muslim',1);
...
insert  into `tb_pengajuan`(`id`,`id_pengajuan`,`id_alternatif`,`tgl_pengajuan`,`jaminan`,`karakter`,`kemampuan`,`pendapatan`,`pengeluaran`,`kondisi_hutang`,`sudah_proses`,`aktif`) values 
(1,'PGJ000001',1,'2022-04-17','1','7','5','5','4','9',0,1),
(2,'PGJ000002',2,'2022-04-17','3','6','4','2','3','8',0,1),
(3,'PGJ000003',3,'2022-05-03','1','7','10','8.5','2.5','9',1,1),
(4,'PGJ000004',4,'2022-05-03','3','7','5','5.5','1.5','8',1,1);
...
insert  into `tb_pengguna`(`id`,`id_pengguna`,`nama_pengguna`,`username`,`password`,`jabatan`,`aktif`) values 
(1,'U001','Wayan Admin','admin','$2y$10$JSk.ma9W0H3h0QpdwYc6wuaNN.K0FLxxmD3yMIWPhW9uUKvB3x8qS','Admin',1),
(2,'U002','Kadek Manager','manager','$2y$10$4.J.Dotnoqr9GceIt54l7u2x4Y8kAFzUHEUvngbSmIGAjYT7TnGP.','Manager',1);
